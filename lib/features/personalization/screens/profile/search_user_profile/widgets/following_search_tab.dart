        ...
        itemBuilder: (_, index) {
            if (index == 0) {
              return Padding(
                ...
                child: FocusedTextField(
                  controller: followSearchController.searchQueryFollowingController,
            ...
            if (itemIndex == followSearchController.followingResults.length + 1) {
              ...
              ? Align(
                ...
                child: TextButton(
                  onPressed: () => followSearchController.loadFollowingPage(), 
                  child: Text(
                    'Carregar mais', 
            ...
            return UserSearchTile(user: followSearchController.followingResults[itemIndex],);
        },
        shrinkWrap: true,
      ),  
    );
