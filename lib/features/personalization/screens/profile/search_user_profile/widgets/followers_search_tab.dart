...
class FollowersSearchTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ProfileBaseController profileBaseController =
        Get.put(ProfileBaseController(userId: userId), tag: userId);
      ...
      () => ListView.builder(
        ...
        itemBuilder: (_, index) {
          if (index == 0) {
            return Padding(
                ...
                child: SearchInput(
                  ...
                  controller:
                      followSearchController.searchQueryFollowersController,
          ...
          if (itemIndex == followSearchController.followersResults.length + 1) {
            return followSearchController.showMoreButton
                ? Align(
                    ...
                    child: TextButton(
                        onPressed: () =>
                            followSearchController.loadFollowersPage(),
                        child: Text(
                          'Carregar mais',
          ...
          return UserSearchTile(
            user: followSearchController.followersResults[itemIndex],
            isUserFollow: profileBaseController.user.value.id ==
